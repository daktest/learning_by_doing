...
Create a new Television with 'new'.  It has channels 3 to 500 and the volume goes from
 ...
 - check whether it's on or not by calling 'on?'; nothing else responds unless it's on
 ...
 - 'mute' sets the volume to 0; if already muted, it sets it to whatever it was before
    mute was called.
